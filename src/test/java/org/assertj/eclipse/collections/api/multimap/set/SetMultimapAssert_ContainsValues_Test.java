...
public class SetMultimapAssert_ContainsValues_Test implements AbstractMultimapAssert_ContainsValues_Contract<String, String, SetMultimap<String, String>, SetMultimapAssert<String, String>> {
  @Override
