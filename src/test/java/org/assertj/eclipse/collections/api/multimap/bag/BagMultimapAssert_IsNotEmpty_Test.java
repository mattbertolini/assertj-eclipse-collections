...
public class BagMultimapAssert_IsNotEmpty_Test implements AbstractMultimapAssert_IsNotEmpty_Contract<String, String, BagMultimap<String, String>, BagMultimapAssert<String, String>> {
  @Override
