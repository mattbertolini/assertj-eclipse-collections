...
class SetMultimapAssert_IsNullOrEmpty_Test implements AbstractMultimapAssert_IsNullOrEmpty_Contract<String, String, SetMultimap<String, String>, SetMultimapAssert<String, String>> {
  @Override
