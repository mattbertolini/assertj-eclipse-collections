...
public class BagMultimapAssert_ContainsKeys_Test implements AbstractMultimapAssert_ContainsKeys_Contract<String, String, BagMultimap<String, String>, BagMultimapAssert<String, String>> {
  @Override
