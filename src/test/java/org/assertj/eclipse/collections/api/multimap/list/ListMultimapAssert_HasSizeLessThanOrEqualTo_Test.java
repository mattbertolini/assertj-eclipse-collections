...
class ListMultimapAssert_HasSizeLessThanOrEqualTo_Test implements AbstractMultimapAssert_HasSizeLessThanOrEqualTo_Contract<String, String, ListMultimap<String, String>, ListMultimapAssert<String, String>> {
  @Override
