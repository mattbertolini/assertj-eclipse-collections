...
public class BagMultimapAssert_HasSizeGreaterThanOrEqualTo_Test implements AbstractMultimapAssert_HasSizeGreaterThanOrEqualTo_Contract<String, String, BagMultimap<String, String>, BagMultimapAssert<String, String>> {
  @Override
