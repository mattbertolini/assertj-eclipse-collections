...
class SetMultimapAssert_HasKeySatisfying_Test implements AbstractMultimapAssert_HasKeySatisfying_Contract<String, String, SetMultimap<String, String>, SetMultimapAssert<String, String>> {
  @Override
