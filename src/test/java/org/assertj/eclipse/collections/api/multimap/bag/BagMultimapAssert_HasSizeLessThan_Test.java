...
class BagMultimapAssert_HasSizeLessThan_Test implements AbstractMultimapAssert_HasSizeLessThan_Contract<String, String, BagMultimap<String, String>, BagMultimapAssert<String, String>> {
  @Override
