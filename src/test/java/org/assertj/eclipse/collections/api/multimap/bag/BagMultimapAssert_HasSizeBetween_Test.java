...
public class BagMultimapAssert_HasSizeBetween_Test implements AbstractMultimapAssert_HasSizeBetween_Contract<String, String, BagMultimap<String, String>, BagMultimapAssert<String, String>> {
  @Override
