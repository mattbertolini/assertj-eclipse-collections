...
public class ListMultimapAssert_HasSizeBetween_Test implements AbstractMultimapAssert_HasSizeBetween_Contract<String, String, ListMultimap<String, String>, ListMultimapAssert<String, String>> {
  @Override
