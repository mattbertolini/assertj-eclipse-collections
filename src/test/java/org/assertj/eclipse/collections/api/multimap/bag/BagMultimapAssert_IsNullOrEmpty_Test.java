...
class BagMultimapAssert_IsNullOrEmpty_Test implements AbstractMultimapAssert_IsNullOrEmpty_Contract<String, String, BagMultimap<String, String>, BagMultimapAssert<String, String>> {
  @Override
