...
public class BagMultimapAssert_HasSizeGreaterThan_Test implements AbstractMultimapAssert_HasSizeGreaterThan_Contract<String, String, BagMultimap<String, String>, BagMultimapAssert<String, String>> {
  @Override
