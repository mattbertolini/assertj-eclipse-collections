...
public class ListMultimapAssert_ContainsKeys_Test implements AbstractMultimapAssert_ContainsKeys_Contract<String, String, ListMultimap<String, String>, ListMultimapAssert<String, String>> {
  @Override
