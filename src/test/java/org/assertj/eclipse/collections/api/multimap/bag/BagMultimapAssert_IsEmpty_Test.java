...
class BagMultimapAssert_IsEmpty_Test implements AbstractMultimapAssert_IsEmpty_Contract<String, String, BagMultimap<String, String>, BagMultimapAssert<String, String>> {
  @Override
