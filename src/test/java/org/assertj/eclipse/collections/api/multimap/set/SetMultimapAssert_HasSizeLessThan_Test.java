...
class SetMultimapAssert_HasSizeLessThan_Test implements AbstractMultimapAssert_HasSizeLessThan_Contract<String, String, SetMultimap<String, String>, SetMultimapAssert<String, String>> {
  @Override
