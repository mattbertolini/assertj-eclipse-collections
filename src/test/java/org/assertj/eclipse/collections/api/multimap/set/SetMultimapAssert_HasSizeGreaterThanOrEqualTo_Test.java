...
public class SetMultimapAssert_HasSizeGreaterThanOrEqualTo_Test implements AbstractMultimapAssert_HasSizeGreaterThanOrEqualTo_Contract<String, String, SetMultimap<String, String>, SetMultimapAssert<String, String>> {
  @Override
