...
class ListMultimapAssert_HasValueSatisfying_Test implements AbstractMultimapAssert_HasValueSatisfying_Contract<String, String, ListMultimap<String, String>, ListMultimapAssert<String, String>> {
  @Override
