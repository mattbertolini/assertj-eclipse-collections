...
class SetMultimapAssert_HasDistinctSize_Test implements AbstractMultimapAssert_HasDistinctSize_Contract<String, String, SetMultimap<String, String>, SetMultimapAssert<String, String>> {
  @Override
