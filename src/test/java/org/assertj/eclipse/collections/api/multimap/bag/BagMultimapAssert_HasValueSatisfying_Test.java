...
class BagMultimapAssert_HasValueSatisfying_Test implements AbstractMultimapAssert_HasValueSatisfying_Contract<String, String, BagMultimap<String, String>, BagMultimapAssert<String, String>> {
  @Override
